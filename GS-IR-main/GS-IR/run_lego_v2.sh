...
OUTPUT_PATH="outputs/lego_gt_v3"
...
python train.py -m $OUTPUT_PATH/ -s $SCENE_PATH --iterations 30000 --eval
...
python train.py -m $OUTPUT_PATH/ -s $SCENE_PATH --start_checkpoint $OUTPUT_PATH/chkpnt30000.pth --iterations 35000 --eval --gamma --indirect
